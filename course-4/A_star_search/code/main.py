...
# Read files
###############################################################################
node_reader = np.loadtxt("course-4\A_star_search\Scene5_example\\nodes.csv", 
                                                                delimiter=",")
edge_reader = np.loadtxt("course-4\A_star_search\Scene5_example\edges.csv", 
                                                                delimiter=",")
...
if __name__=='__main__':
    ...
    print("Path:\n",path)
    path = np.array(path)
    np.savetxt("course-4\A_star_search\Scene5_example\path.csv", 
